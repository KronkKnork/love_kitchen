                ...
                var p = function(t) {
                    ...
                    b = function(t, e) {
                        ...
                        t.onclick = function(t) {
                            ...
                            if (t.path[3].classList[1] === 'slick-current') {
                                t.preventDefault(), h.show(n);
                                var last_index = $('#zuck-modal-content .wrap span:last-child').attr('data-index');
                                $('#zuck-modal-content .wrap span').on('click', function(){
                                    let number = $(this).attr('data-index');
                                    let back = last_index - number;
                                    for (var i = 0; i < back; i++) {
                                        /*$('#zuck-modal-slider-stories').trigger('touchstart');
                                        $('#zuck-modal-slider-stories').trigger('mousedown');*/
                                    }
                                    /*$('#zuck-modal-content .wrap span').slice(number).removeClass('seen');
                                    $('#zuck-modal-content .wrap span').slice(number).removeClass('active');*/
                                    /*$('#zuck-modal-content .slides .item').slice(number).removeClass('seen');
                                    $('#zuck-modal-content .slides .item').slice(number).removeClass('active');*/
                                })
                            } else {
                                $('.next').trigger('click');
                            }
