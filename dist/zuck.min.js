                ...
                var p = function(t) {
                    ...
                    g = {
                        ...
                        template: {
                            timelineItem: function(t) {
                                return '\n            <div class="story '.concat(!0 === i(t, "seen") ? "seen" : "", '">\n              <a class="item-link" ').concat(i(t, "link"), '">\n                <span class="item-preview">\n                  <img lazy="eager" src="').concat(u("avatars") || !i(t, "currentPreview") ? i(t, "photo") : i(t, "currentPreview"), '" />\n                </span>\n                <span class="info" itemProp="author" itemScope itemType="http://schema.org/Person">\n                  <strong class="name" itemProp="name">').concat(i(t, "name"), '</strong>\n                  <span class="time">').concat(i(t, "lastUpdatedAgo"), '</span>\n                </span>\n              </a>\n              \n              <ul class="items"></ul>\n            </div>')
                            },
                            ...
                            viewerItem: function(t, e) {
                                return '<div class="story-viewer">\n                    <div class="head">\n                      <div class="left">\n                        '.concat(u("backButton") ? '<a class="back">&lsaquo;</a>' : "", '\n\n                        <span class="item-preview">\n                          <img lazy="eager" class="profilePhoto" src="').concat(i(t, "photo"), '" />\n                        </span>\n\n                        <div class="info">\n                          <strong class="name">').concat(i(t, "name"), '</strong>\n                          <span class="time">').concat(i(t, "timeAgo"), '</span>\n                        </div>\n                      </div>\n\n                      <div class="right">\n                        <span class="time">').concat(i(e, "timeAgo"), '</span>\n                        <span class="loading"></span>\n                        <a class="close" href="#stories-anchor" tabIndex="2"></a>\n                      </div>\n                    </div>\n\n                    <div class="slides-pointers">\n                      <div class="wrap"></div>\n                    </div>\n\n                    ').concat(u("paginationArrows") ? '<div class="slides-pagination">\n                          <span class="previous">&lsaquo;</span>\n                          <span class="next">&rsaquo;</span>\n                        </div>' : "", "\n                  </div>")
                            },
                            viewerItemPointer: function(t, e, n) {
                                return '<span \n                    class="'.concat(e === t ? "active" : "", " ").concat(!0 === i(n, "seen") ? "seen" : "", '"\n                    data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n                      <b style="animation-duration:').concat("" === i(n, "length") ? "3" : i(n, "length"), 's"></b>\n                  </span>')
                            },
                            viewerItemBody: function(t, e, n) {
                                return '<div \n                    class="item '.concat(!0 === i(n, "seen") ? "seen" : "", " ").concat(e === t ? "active" : "", '"\n                    data-time="').concat(i(n, "time"), '" data-type="').concat(i(n, "type"), '" data-index="').concat(t, '" data-item-id="').concat(i(n, "id"), '">\n                    ').concat("video" === i(n, "type") ? '<video class="media" muted webkit-playsinline playsinline preload="auto" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), '></video>\n                        <b class="tip muted">').concat(u("language", "unmute"), "</b>") : '<img loading="auto" class="media" src="'.concat(i(n, "src"), '" ').concat(i(n, "type"), " />\n                    "), "\n\n                    ").concat(i(n, "link") ? '<div class="tip link title-in-story">'.concat(i(n, "link"), '</div><div class="tip link">\n                            ').concat(i(n, "linkText") && "" !== i(n, "linkText") ? i(n, "linkText") : u("language", "visitLink"), "\n                          </div>") : "", "\n                  </div>")
                            }
                        },
                        language: {
                        ...
                        return {
                            ...
                            next: function(t) {
                                u("callbacks", "onEnd")(d.internalData.currentStory, (function() {
                                    ...
                                    e && (e.classList.add(""), d.data[t].seen = !0, d.internalData.seenItems[t] = !0, E("seenItems", d.internalData.seenItems), w()), a("#zuck-modal .story-viewer.next") ? u("rtl") ? b(!1) : b(!0) : h.close()
                                }))
                            },
                            close: function() {
                                var t = a("#zuck-modal");
                                u("callbacks", "onClose")(d.internalData.currentStory, (function() {
                                    ...
                                    //console.log($('.header-menu').find('.menu-item:nth-child(4)').trigger('click'));
                                }))
                            }
                        }
                    }(),
                    b = function(t, e) {
                        ...
                        t.onclick = function(t) {
                            console.log(t.srcElement.offsetParent.classList[1] === 'slick-current');
                            if ((t.srcElement.offsetParent.classList[1] === 'slick-current') || ($(window).width() < 690)) {
                        ...
                        t.addEventListener('touchstart', function(t) {
                            initialPoint=t.changedTouches[0];
                        }, false);
                        t.addEventListener('touchend', function(t) {
                            finalPoint=t.changedTouches[0];
                            var xAbs = Math.abs(initialPoint.pageX - finalPoint.pageX);
                            var yAbs = Math.abs(initialPoint.pageY - finalPoint.pageY);
                            console.log(xAbs,yAbs);
                            if (xAbs < 1 && yAbs < 1) {
                                    //console.log(t.path[3].classList[1]);
                                    if ((t.srcElement.offsetParent.classList[1] === 'slick-current') || ($(window).width() < 1090)) {
                                        t.preventDefault(), h.show(n);
                                    } else {
                                        $('.next').trigger('click');
                                    }
                        ...
                        /*t.ontouchstart = function(t) {
                            ...
                            // t.stopPropagation();
                            // ldelay=new Date();
                            // betw.x=t.changedTouches[0].pageX;
                            // betw.y=t.changedTouches[0].pageY;
                            // }, false);
                            // /*Ловим отпускание пальца*/
                            // t.addEventListener('touchend', function(t) {
                            // var pdelay=new Date();
                            // if(t.changedTouches[0].pageX==betw.x &&
                            // t.changedTouches[0].pageY==betw.y &&
