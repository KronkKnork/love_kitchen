 ...
 */
 ...
 /** Updated Можно накинуть на кнопку вперед строка  611*/
...
$(document).ready(function() {
    ...
    if (window.matchMedia('(max-width: 1089px)').matches) {
        carousel_width = 280;
        carousel_height = 300;
        carousel_separation = 400;
        carousel_sizeMultiplier = 1;
    ...
    $.fn.waterwheelCarousel = function(startingOptions) {
        ...
        function initializeCarouselData() {
            data = {
                ...
                totalItems: $(carousel).find('div.story').length,
        ...
        var initialPoint;
        var finalPoint;
        document.getElementById('stories').addEventListener('touchstart', function(event) {
            initialPoint=event.changedTouches[0];
        }, false);
        document.getElementById('stories').addEventListener('touchend', function(event) {
        ...
        function preload(callback) {
            ...
            var $imageElements = data.itemsContainer.find('div.story img'),
                loadedImages = 0,
        ...
        function setOriginalItemDimensions() {
            data.itemsContainer.find('div.story').each(function() {
        ...
        function preCalculatePositionProperties() {
            ...
            var $firstItem = data.itemsContainer.find('div.story');
        ...
        function setupCarousel() {
            ...
            data.items = data.itemsContainer.find('div.story');
            ...
            data.itemsContainer
                ...
                .each(function() {
                    ...
                    $('.left-block-dn').width(centerPosLeft+6);
                    // if (window.matchMedia('(max-width: 1089px)').matches) {
                    //     console.log(centerPosLeft = 40);
                    // }
                    $(this)
         ...
         */
        /**$(this).find('div.story').bind("click", function() {
        ...
        $('.stories').find('div.story').on("mousedown", function(event) {
            data.mcox = event.pageX;
        });

        $('.stories').find('div.story').on("mousemove", function(event) {
            data.cox = event.pageX;
        });
        $('.stories').find('div.story').on("mouseup", function(event) {

            if (data.mcox < data.cox) {
                data.currentDirection = 'backward';
                rotateCarousel(Math.abs(0));
            }
            if (data.mcox > data.cox) {
                data.currentDirection = 'forward';
                rotateCarousel(Math.abs(0));
        ...
        /*$(this).find('a').bind("click", function(event) {
            var isCenter = $(this).find('div.story').data('currentPosition') == 0;
        ...
        this.reload = function(newOptions) {
            ...
            data.itemsContainer.find('div.story').hide();
